...
public class MyButton extends JButton {
  ...
  protected void paintChildren(Graphics g) {
    ...
    if (enableBorder) {
      ...
      g.fillRect(AppSettings.getInt("Border_Size") / 2, AppSettings.getInt("Border_Size") / 2, getWidth() - AppSettings.getInt("Border_Size"), getHeight() - AppSettings.getInt("Border_Size"));
      g.setColor(getBackground());
