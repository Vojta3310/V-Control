...
public class XML {
  ...
  public XML(String file) throws IOException {
    ...
    Logger.getLogger(this.getClass().getName()).log(Level.FINE, "XML File: " + this.file
  ...
  public ISklad read() throws ParserConfigurationException, SAXException, IOException {
    if (file != null && new File(file).exists()) {
      ...
      Reader freader = new InputStreamReader(inputStream, "UTF-8");
...
//        FileWriter outputFile = new FileWriter(file);
    ...
    XMLStreamWriter writer = xmlof.createXMLStreamWriter(output, "UTF-8");

    writer.writeStartDocument("UTF-8", "1.0"); //---- on the fucking windows doesnt work well! 
    int a = 0;
    Box box;
